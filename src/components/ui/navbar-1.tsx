...
const PORTAL_URL = 'https://clients.localboostnetworking.com/login';
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex justify-center w-full py-4 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-white rounded-full shadow-lg w-full max-w-3xl relative">
        ...
        {/* Desktop: client login, then the primary CTA */}
        ...
        <motion.a
          ...
          className="inline-flex items-center justify-center px-5 py-2 text-sm font-semibold text-gray-900 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors shadow-sm"
          initial={{ opacity: 0, x: 20 }}
          animate={{ opacity: 1, x: 0 }}
